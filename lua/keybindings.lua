...
map("n", "<C-d>", "9j", opt,{ desc = "format document [LSP]" })
...
-- wincmd
map("n","<leader>l",":wincmd l<cr>", {desc = "Move to Right Window"})
map("n","<leader>h",":wincmd h<cr>", {desc = "Move to Left Window"})
map("n","<leader>k",":wincmd k<cr>", {desc = "Move to Upper Window"})
map("n","<leader>j",":wincmd j<cr>", {desc = "Move to Lower Window"})
...
map("n","<C-l>",":BufferLineCycleNext<CR>",{desc = "Next Buffer"})
map("n","<C-h>",":BufferLineCyclePrev<CR>", {desc = "Previous Buffer"})
map("n", "<A-l>",":BufferLineMoveNext<CR>", {desc = "Move Buffer to the Next"})
map("n", "<A-h>",":BufferLineMovePrev<CR>", {desc = "Move Buffer to the Previous"})
...
map("i","<C-n>",":NvimTreeToggle<CR>", {desc = "Toggle File Tree"})
map("v","<C-n>",":NvimTreeToggle<CR>", {desc = "Toggle File Tree"})
...
vim.keymap.set("n", "<leader>xw", "<cmd>TroubleToggle workspace_diagnostics<cr>",
  {silent = true, noremap = true, desc = "Toggle Error Analysis [Workspace]"}
)
vim.keymap.set("n", "<leader>xd", "<cmd>TroubleToggle document_diagnostics<cr>",
  {silent = true, noremap = true, desc = "Toggle Error Analysis [Documents]"}
)
vim.keymap.set("n", "<leader>xl", "<cmd>TroubleToggle loclist<cr>",
  {silent = true, noremap = true, desc = "Toggle Error Analysis [Local Lists]"}
)
vim.keymap.set("n", "<leader>xq", "<cmd>TroubleToggle quickfix<cr>",
  {silent = true, noremap = true, desc = "Toggle Quick Fix"}
)
