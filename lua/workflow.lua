...
vim.keymap.set(
	"n",
	"<leader>oo",
	":cd /Users/morrischang/Library/Mobile\\ Documents/iCloud~md~obsidian/Documents/MoooBrain/<cr>"
)
--
...
vim.keymap.set(
	"n",
	"<leader>oz",
	':Telescope live_grep search_dirs={"/Users/morrischang/Library/Mobile\\ Documents/iCloud~md~obsidian/Documents/MoooBrain/5\\ -\\ Notes"}<cr>'
)
vim.keymap.set(
	"n",
	"<leader>os",
	':Telescope find_files search_dirs={"/Users/morrischang/Library/Mobile\\ Documents/iCloud~md~obsidian/Documents/MoooBrain/5\\ -\\ Notes"}<cr>'
)
...
vim.keymap.set(
	"n",
	"<leader>ok",
	":Markview<cr>:!mv '%:p' /Users/morrischang/Library/Mobile\\ Documents/iCloud~md~obsidian/Documents/MoooBrain/8\\ -\\ Zettelkasten<cr>:bd<cr>"
)
-- delete file in current buffer
vim.keymap.set("n", "<leader>odd", ":Markview<cr>:!rm '%:p'<cr>:bd<cr>")
