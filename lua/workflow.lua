...
--
-- navigate to vault
vim.keymap.set("n", "<leader>oo", ":cd /Users/morrischang/Documents/Obsidian/MoooBrain<cr>")
--
...
vim.keymap.set("n", "<leader>os",
    ":Telescope find_files search_dirs={\"/Users/morrischang/Documents/Obsidian/MoooBrain/5\\ -\\ Notes\"}<cr>")
vim.keymap.set("n", "<leader>oz",
    ":Telescope live_grep search_dirs={\"/Users/morrischang/Documents/Obsidian/MoooBrain/5\\ -\\ Notes\"}<cr>")
--
...
vim.keymap.set("n", "<leader>ok",
    ":!mv '%:p' /Users/morrischang/Documents/Obsidian/MoooBrain/8\\ -\\ Zettelkasten<cr>:bd<cr>")
